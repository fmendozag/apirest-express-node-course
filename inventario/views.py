    ...
    if request.method == 'POST':
        try:
            ...
            if accion == 'producto_cod':
                ...
                #
                #         precio = round(costo + (costo * (porc_rent_costo_credito / 100)), 4)
                #     else:
                #         try:
                #             porc_rent_costo_contado = Decimal(grupo.rentabilidad_costo_contado)
                #         except:
                #             porc_rent_costo_contado = Decimal('0.0')
                #         precio = round(costo + (costo * (porc_rent_costo_contado / 100)), 4)

                # costo = Decimal(inv.producto.costo_compra)
                # if tipo == '0':
                #     try:
                #         porc_rent_costo_credito = Decimal(inv.producto.rentabilidad_costo_credito)
                #     except:
                #         porc_rent_costo_credito = Decimal('0.0')
                #
                #     precio = round(costo + (costo * (porc_rent_costo_credito / 100)), 4)
                ...
                # else:
                #     try:
                #         porc_rent_costo_contado = Decimal(inv.producto.rentabilidad_costo_contado)
                #     except:
                #         porc_rent_costo_contado = Decimal('0.0')
                #
                #     precio = round(costo + (costo * (porc_rent_costo_contado / 100)), 4)
                ...
                #         precio = round(precio * Decimal('1.12'),4)
                # except:
                #     pass

                if tipo == '0':
                    precio = round(inv.producto.web_precio_credito, 4)
                else:
                    precio = round(inv.producto.web_precio_contado, 4)
            ...
            if accion == 'producto_cod_all':
                ...
                #     costo = Decimal(inv.producto.costo_compra)
                #     if tipo == '0':
                #         rent_pvp_credito = round(costo * (porc_rent_costo_credito / 100), 4)
                #         precio = round(costo + (costo * (porc_rent_costo_credito / 100)), 4)
                #     else:
                #         rent_pvp_contado = round(costo * (porc_rent_costo_contado / 100), 4)
                #         precio = round(costo + (costo * (porc_rent_costo_contado / 100)), 4)

                # porc_rent_costo_contado = Decimal(inv.producto.rentabilidad_costo_contado)
                # porc_rent_costo_credito = Decimal(inv.producto.rentabilidad_costo_credito)
                # porc_comi_pvp_contado = Decimal(inv.producto.comision_pvp_contado)
                # porc_comi_pvp_credito = Decimal(inv.producto.comision_pvp_credito)
                ...
                data['producto'] = {
                    ...
                    #"cuentaid": cuentaid,
                    "comision_contado": inv.producto.web_comision_contado,
                    "comision_credito": inv.producto.web_comision_credito,
                }
                data['resp'] = True
                return JsonResponse(data, status=200)
