...
from inventario.sugerido_transferencia import InvSugeridoTransferencia
from inventario.filtro_sugerido_transferencia import get_productos_empaque
...
urlpatterns = [
    ...
    path('ajax/consultar/empaques',get_productos_empaque,name="inv_consultar_empaques"),
    path('ajax/consultar/productos/',get_productos_empaque,name="inv_consultar_productos"),
    ...
    path('sugerido/transferencia/',InvSugeridoTransferencia.as_view(),name="inv_sugerido_tranferencia"),
