...
from cliente.models import CliCotizaciones, CliClientes, CliCotizacionesDetalle, CliRubros
...
from venta.models import VenFacturasDetalle, VenFacturas


class PosPuntoVentaCartilla(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if accion == 'guadar-factura-cartilla':
                    ...
                    for i in range(paginas):
                        if contado and forma_pago == 'EFE':
                            ...
                            factura = VenFacturas(
                                ...
                                nocontrola_stock=not controla_stock,
                                nota=json_data['nota'],
                        ...
                        # with connection.cursor() as cursor:
                        #     cursor.execute("{CALL SEG_UsuariosBitacora_Insert(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)}",
                        #         (
                        #             str(request.user.id),
                        #             tipo,
                        #             cliente.nombre,
                        #             'CREAR',
                        #             'POS_DOCUMENT_FACTURAS_BARRAS',
                        #             factura.id,
                        #             factura.id,
                        #             request.user.username,
                        #             sucursalid,
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            return render(request, 'pos/pos_punto_venta_cartilla.html', data)
        except Exception as e:
