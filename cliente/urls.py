...
from cliente.cliente_deuda import get_consulta_cliente_cartilla,CliClienteDeudaCartilla
from seguridad.decorators import permiso_modulo
urlpatterns = [
    path('clientes/consultar',get_consulta_cliente,name="cli_consulta_cliente"),
    path('clientes/consultar/cartilla',get_consulta_cliente_cartilla,name="cli_consulta_cliente_cartilla"),
