...
class CliClientes(models.Model):
    ...
    precio_lista = models.BooleanField(db_column='PrecioLista', blank=True, null=True,default=False)  # Field name made lowercase.
    ...
    precio_activo = models.DecimalField(db_column='PrecioActivo', max_digits=1, decimal_places=0, blank=True, null=True,default=1)  # Field name made lowercase.
    ...
    referencia = models.CharField(db_column='referencia',max_length=50, blank=True, null=True,default='')
    ...
    def save(self, force_insert=False, force_update=False, using=None, **kwargs):
        ...
        try:
            ...
            self.precio_lista = True
            self.precio_activo = 2
...
class CliClientesDeudas(models.Model):
    ...
    valor_base = models.DecimalField(db_column='ValorBase', max_digits=19, decimal_places=4)  # Field name made lowercase.
    ...
    rubro = models.ForeignKey(CliRubros, models.DO_NOTHING,db_column='RubroID', max_length=10)  # Field name made lowercase.
    cta_cxcobrar = models.ForeignKey('contabilidad.AccCuentas',models.DO_NOTHING,db_column='CtaCxCID', max_length=10)  # Field name made lowercase.
...
class CliCotizaciones(models.Model):
    ...
    nombre = models.CharField(db_column='Cliente', max_length=50,default='')  # Field name made lowercase.
    vendedor = models.ForeignKey('empleado.EmpEmpleados',models.DO_NOTHING,db_column='VendedorID', max_length=10,default='')  # Field name made lowercase.
    divisaid = models.CharField(db_column='DivisaID', max_length=10,default='')  # Field name made lowercase.
    cambio = models.DecimalField(db_column='Cambio', max_digits=12, decimal_places=6,default=1)  # Field name made lowercase.
    atentamente = models.CharField(db_column='Atentamente', max_length=60,default='')  # Field name made lowercase.
    validez = models.CharField(db_column='Validez', max_length=30,default='')  # Field name made lowercase.
    ...
    division = models.CharField(db_column='DivisiónID', max_length=10,default='')  # Field name made lowercase.
    ...
    nota = models.CharField(db_column='Nota', max_length=1024,default='')  # Field name made lowercase.
    anulado = models.BooleanField(db_column='Anulado',default=False)  # Field name made lowercase.
    creadopor = models.CharField(db_column='CreadoPor', max_length=15, blank=True, null=True,editable=False)  # Field name made lowercase.
    ...
    sucursalid = models.CharField(db_column='SucursalID', max_length=2, blank=True, null=True,editable=False)  # Field name made lowercase.
    pcid = models.CharField(db_column='PcID', max_length=50, blank=True, null=True,default='',editable=False)  # Field name made lowercase.
    caja = models.ForeignKey('banco.BanBancos', models.DO_NOTHING, db_column='CajaID', max_length=10, blank=True,null=True)
...
class CliCotizacionesDetalle(models.Model):
    ...
    precioname = models.CharField(db_column='PrecioName', max_length=40, blank=True, null=True,default='')  # Field name made lowercase.
    ...
    anulado = models.BooleanField(db_column='Anulado', blank=True, null=True,default=False)  # Field name made lowercase.
